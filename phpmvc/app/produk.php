...
<head>
    ...
    <title>Kelola Produk - OKE JASA</title>
                        ...
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="produk.php">Jasa</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Daftar Jasa</h2>
									<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2">Tambah Jasa</button>
                                </div>
...
>>>>>>> 3d35633b8427107b41ee17726aa61811974005b6
